...
try:
    ...
    # Create a simple Student class if the import fails
    class Student:
...
class ClassCreationView(QWidget):
    ...
    def setup_ui(self):
        ...
        home_link.setStyleSheet("color: #666666;")
        ...
        form_frame.setStyleSheet("background-color: white; border: 1px solid #dadada; border-radius: 5px;")
        ...
        self.name_input.setPlaceholderText("e.g., Mental Health Lab")
        ...
        years = [str(year) for year in range(current_year - 1, current_year + 6)]
        self.year_combo.addItems(years)
        self.year_combo.setCurrentText(str(current_year))
        
        quarter_layout.addWidget(self.season_combo)
        quarter_layout.addWidget(self.year_combo)
        
        form_layout.addWidget(quarter_label)
        form_layout.addLayout(quarter_layout)
        form_layout.addSpacing(10)
    ...
    def add_custom_track(self):
        ...
        # Add to UI
        tracks_container = self.findChild(QWidget, "tracks_container")
        if tracks_container and tracks_container.layout():
            tracks_container.layout().addWidget(checkbox)
        else:
            # Fallback - just update the selected tracks
